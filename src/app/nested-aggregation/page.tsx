...
import ResourceAccessQuery from '@/components/nested-aggregation/nested-aggregation';
import BackgroundImage from '@/assets/img/login-image.jpg';

export default function ResourceAccessQueryPage() {
  return (
